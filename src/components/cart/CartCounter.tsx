...
export const CartCounter = () => {
  ...
  return (
    <a href="/cart" className="relative inline-block">
      {$itemsInCart > 0 && (
        <span className=" mr-4 absolute -top-2 -right-2 flex justify-center items-center bg-blue-600 text-white text-xs rounded-full w-5 h-5">
          {$itemsInCart}
        </span>
      )}
      ...
      <svg
        ...
        className="mr-4"
      >
        <title id="cartIconTitle">Carrito de compras</title>
        <path
          fill="black"
